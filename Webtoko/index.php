...
<body style="font-size: 24px;">
    <nav class="navbar navbar-light navbar-expand-md navigation-clean-button" style="background-color: #00000;">
        <div class="container"><img src="assets/img/udinus.jpg" style="width: 8%;"><a class="navbar-brand" href="#" style="font-size: 20px;">ORMATRADE</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            ...
            <?php foreach ($produk_produk as $row) : ?>
                <div class="col-sm-6 col-md-4 product-item">
                    <div class="product-container">
                        <div class="row">
                            <div class="col-md-12"><a class="product-image" href="#"><img src="admin/dist/assets/img/<?= $row["foto_produk"]; ?>" style="width: 175px;height: 200px;"></a></div>
                        </div>
                        <div class="row">
                            <div class="col-8">

...
function cariProduk($data)
{
    ...
    $stmt = mysqli_prepare($conn, "SELECT * FROM produk WHERE nama_produk LIKE ?");
...
function login($data)
{
    ...
    // Mengecek apakah variabel sesi untuk jumlah percobaan sudah ada
    if (!isset($_SESSION['login_attempts'])) {
        $_SESSION['login_attempts'] = 0;
    }

    // Mengecek apakah sudah melebihi batas percobaan
    ...
    if ($_SESSION['login_attempts'] >= 4) {
        // Jika sudah melebihi, arahkan kembali ke halaman index.php

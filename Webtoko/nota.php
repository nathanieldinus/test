...
<body>
    <div class="container-fluid">
        <nav class="navbar navbar-light navbar-expand-md navigation-clean-button" style="background-color: #fff;">
            <div class="container"><img src="assets/img/udinus.jpg" style="width: 100px;"><a class="navbar-brand" href="#" style="font-size: 20px;">ORMATRADE</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <div class="form-group alert alert-info w-auto">
                                        <p class="w-100" style="font-size: medium;">
                                            ...
                                            <!-- <br> -->
                                            <strong>BANK BCA 4199-0101-0791-531 AN. Mario Rivandiego</strong>
                                        </p>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-12">
